...
void BasicRenderer::Println(const char* s){
    Print(s);
    Next();
}
...
void BasicRenderer::ClearLine(int line){
    int tempX = CursorPosition.X;
    int tempY = CursorPosition.Y;
    int line2 = line * 8;
    CursorPosition.Y = line2;
    CursorPosition.X = 1920;
