...
//{
//	pic_send_eoi(ATA_PRIMARY_IRQ);
//}
//
//void ide_secondary_irq()
//{
//	pic_send_eoi(ATA_SECONDARY_IRQ);
//}
//
...
//	GlobalRenderer->Print("Sent IDENTIFY");
//	/* Now, read status  */
...
//void ata_init()
//{
//	GlobalRenderer->Print("Checking for ATA drives\n");
//	ide_buf = (uint8_t *)_malloc(512);
